...
/*constructor */
class Pet{
    constructor(name,age,gender,type,breed,service,price,paymentMethod,ownersName,contactPhone){
        this.name=name;
        this.age=age;
        this.gender=gender;
        this.type=type;
...
var scooby=new Pet("Scooby",50,"Male","Dog","Dane","Full Service",19.99,"Debit Card","Shaggy","5557649845")
var champ=new Pet("Champ",1,"Male","Dog","Pit","Nails",10.5,"Cash","Joel","8978980765");
var tweety=new Pet("Tweety",2,"Female","Bird","Canarian","Full Service",19.99,"Paypal","Silvester","5554336576")
...
const txtpaymentMethod=document.getElementById('paymentMethod');
const txtOwner=document.getElementById('petownersName');
const txtcontactPhone=document.getElementById('petcontactPhone');


function register(){
    var thePet = new Pet(txtName.value,txtAge.value,txtGender.value,txtType.value,txtBreed.value,txtService.value,txtPrice.value,txtpaymentMethod.value,txtOwner.value,txtcontactPhone.value);
...
document.getElementById(`footer`).innerHTML=text;
    ...
    $('#petcontactPhone').keypress(function(e){
        if(e.key==="Enter"){
            register();
        }
    });
